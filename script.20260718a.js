(function () {
  ...
  function initContactForm() {
    ...
    const invitedArrival = Boolean(sourceSlug || invitationId);
    const guidedArrival = Boolean(invitedArrival || requestedRoute);
